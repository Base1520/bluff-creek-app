...
1. Independently confirm the connected Supabase project is exactly \`${EXPECTED_PROJECT_REF}\` and its seven-migration verification is current. SQL cannot verify the project reference; never infer the target from matching table names or user UUIDs. Stop if the connection is uncertain.
