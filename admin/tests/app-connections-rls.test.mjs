...
test('app connection intake and care roles remain private, verified and reviewable', async t => {
  ...
  await pg.exec(await readFile(new URL('../../supabase/migrations/20260907_membership_care.sql', import.meta.url), 'utf8'));
  await pg.exec(await readFile(new URL('../../supabase/migrations/20260907_office_content.sql', import.meta.url), 'utf8'));
  ...
  await pg.exec(await readFile(new URL('../../supabase/migrations/20260907164733_app_connections_care_roles.sql', import.meta.url), 'utf8'));
