...
test('personal leadership follow-ups enforce owner-only access and atomic contact history', async t => {
  ...
  `);
  for (const name of ['schema.sql', 'migrations/20260907_membership_care.sql', 'migrations/20260907_office_content.sql', 'migrations/20260907164733_app_connections_care_roles.sql']) {
  ...
  await pg.exec(await readFile(new URL('../../supabase/migrations/20260907171014_leader_followups.sql', import.meta.url), 'utf8'));
