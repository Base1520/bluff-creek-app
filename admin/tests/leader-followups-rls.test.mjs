...
test('personal leadership follow-ups enforce owner-only access and atomic contact history', async t => {
  ...
  `);
  for (const name of ['migrations/20260908220558_office_base.sql', 'migrations/20260908220613_membership_care.sql', 'migrations/20260908220623_office_content.sql', 'migrations/20260908220645_app_connections_care_roles.sql']) {
  ...
  await pg.exec(await readFile(new URL('../../supabase/migrations/20260908220658_leader_followups.sql', import.meta.url), 'utf8'));
