  ...
  function coverageFor(people, assignments) {
    ...
    (people || []).filter(function (person) { return person.status === 'active'; }).forEach(function (person) {
      ['deacon', 'sunday_school'].forEach(function (role) {
        ...
        var intervalExceedsGoal = plan && (Number.isInteger(months) && months > 0 ? months > (role === 'deacon' ? 3 : 1) : Number.isInteger(days) && days > (role === 'deacon' ? 90 : 28));
  ...
  function create(options) {
    ...
    function mount() {
      ...
      host.innerHTML = '<div class="care-intro"><p class="eyebrow">Know people. Stay in touch.</p><h2>Care that continues.</h2><p>Plan a follow-up, record a visit, and help guests find their next step.</p></div>' +
        ...
        '<section data-care-panel="coverage" aria-label="Care coverage" hidden><div class="care-section-head"><div><h3>No one overlooked.</h3><p>Active people who still need a recurring deacon or Sunday school plan, an assigned person, an unpaused plan, or an interval within the care goal. Historical inactive records and visitors are excluded.</p><p>For monthly Sunday school contact, choose 1 month. A 29- or 30-day plan can skip February; choose 28 days or fewer if using days.</p></div></div><div data-care-list="coverage" class="care-list"></div></section>' +
