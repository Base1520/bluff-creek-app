...
Apply `supabase/migrations/20260907171014_leader_followups.sql` after the base schema, membership/care, office-content and app-connections/care-roles migrations, following the explicit order in [Creek Office setup](../admin/README.md). The filename was generated by the Supabase CLI. The legacy migration version collision described in [signup/care maintenance](signup-care-maintenance.md) still needs normalization before automatic CLI migration ordering.
